...
struct OnboardingView: View {
    ...
    private let pages: [(title: String, subtitle: String, icon: String)] = [
        ("Welcome to {{APP_NAME}}", "Your personal knowledge base", "book.fill"),
        ("Browse Categories", "Find articles organized by topic", "folder.fill"),
        ("Bookmark Favorites", "Save articles for quick access later", "bookmark.fill"),
        ("Search Everything", "Instantly find any content", "magnifyingglass"),
    ]
