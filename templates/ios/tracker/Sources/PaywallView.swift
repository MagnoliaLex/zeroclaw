    ...
    func purchase(_ product: Product) async {
        ...
        do {
            ...
            case .success(let verification):
                ...
                case .verified:
                    isPurchased = true
                    AnalyticsService.shared.trackEvent(AnalyticsEvent.purchaseSuccess, properties: [
...
struct PaywallView: View {
    ...
    private let features: [(String, String)] = [
        ("Unlimited Categories", "square.grid.2x2.fill"),
        ("AI Habit Insights", "sparkles"),
        ("Advanced Trend Charts", "chart.line.uptrend.xyaxis"),
        ("Data Export (CSV)", "square.and.arrow.up"),
        ("Custom Goals & Units", "slider.horizontal.3"),
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Unlock your full tracking potential")
                            .font(.subheadline)
                                ...
                                Button {
                                    ...
                                    HStack {
                                        VStack(alignment: .leading, spacing: 4) {
                                            ...
                                            if let desc = product.description.isEmpty ? nil : product.description {
                                                Text(desc)
                                                    .font(.caption)
                                                    .foregroundStyle(.secondary)
                                            }
